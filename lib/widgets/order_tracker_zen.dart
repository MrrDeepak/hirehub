        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              child: CircleAvatar(backgroundColor: widget.background_color?? Colors.grey,child: Center(child: Icon(Icons.check,color: Colors.white,)),),
            ),
            SizedBox(width: 10),
