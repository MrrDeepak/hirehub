...
class AnswerPageController extends GetxController {
  RxBool isExpanded = false.obs;
}
class Answers extends StatelessWidget {
   Answers({super.key});
   final AnswerPageController answerPageController = Get.put(AnswerPageController());
        ...
        children: [
          Expanded(
            child: PageView.builder(
              ...
              itemCount: submitAnswerApiController.allAnswersData.length,
              // widget.questions.length,
              itemBuilder: (context, index) {
                final data = submitAnswerApiController.allAnswersData[index];
                    ...
                    children: [
                        ...
                        Card(
                          shape: RoundedRectangleBorder(
                            ...
                            borderRadius: BorderRadius.only(
                              ...
                              bottomLeft:
                                  answerPageController.isExpanded.value
                                      ? Radius.circular(0)
                                      : Radius.circular(12),
                              bottomRight:
                                  answerPageController.isExpanded.value
                      ...
                      Obx(() {
                        return AnimatedContainer(
                          ...
                          child: answerPageController.isExpanded.value
                              ? Padding(
