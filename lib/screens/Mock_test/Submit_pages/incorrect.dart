...
class IncorrectPageController extends GetxController {
  RxBool isExpanded = false.obs;
}
class Incorrect extends StatelessWidget {
 Incorrect({super.key});
  final IncorrectPageController incorrectPageController = Get.put(IncorrectPageController());
        ...
        children: [
          Expanded(
            child: PageView.builder(
              ...
              itemCount: submitAnswerApiController.incorrectData.length,
              // widget.questions.length,
              itemBuilder: (context, index) {
                final data = submitAnswerApiController.incorrectData[index];
                    ...
                    children: [
                        ...
                        Card(
                          shape: RoundedRectangleBorder(
                            ...
                            borderRadius: BorderRadius.only(
                              ...
                              bottomLeft:
                                  incorrectPageController.isExpanded.value
                                      ? Radius.circular(0)
                                      : Radius.circular(12),
                              bottomRight:
                                  incorrectPageController.isExpanded.value
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      int answer = int.parse(data.answer.toString());
                      ...
                      Obx(() {
                        return AnimatedContainer(
                          ...
                          child: incorrectPageController.isExpanded.value
                              ? Padding(
