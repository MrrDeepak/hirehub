...
class UnattemptPageController extends GetxController {
  RxBool isExpanded = false.obs;
}

class Unattempt extends StatelessWidget {
  Unattempt({super.key});
  List<String> mcq = ['A)', 'B)', 'C)', 'D)'];
  final MockTestPageController mockTestPageController =
      Get.put(MockTestPageController());
  final UnattemptPageController unattemptPageController =
      Get.put(UnattemptPageController());
        ...
        children: [
          Expanded(
            child: PageView.builder(
              ...
              itemCount: submitAnswerApiController.unattemptData.length,
              // widget.questions.length,
              itemBuilder: (context, index) {
                final data = submitAnswerApiController.unattemptData[index];
                    ...
                    children: [
                        ...
                        Card(
                          shape: RoundedRectangleBorder(
                            ...
                            borderRadius: BorderRadius.only(
                              ...
                              bottomLeft:
                                  unattemptPageController.isExpanded.value
                                      ? Radius.circular(0)
                                      : Radius.circular(12),
                              bottomRight:
                                  unattemptPageController.isExpanded.value
                      ...
                      Obx(() {
                        return AnimatedContainer(
                          ...
                          child: unattemptPageController.isExpanded.value
                              ? Padding(
